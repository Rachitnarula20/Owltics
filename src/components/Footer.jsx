  ...
  return (
    <div className="flex flex-col gradient-2 whole page">
      <div className="flex justify-between pt-24 pb-14 sml:flex-col">
        ...
        <div className="flex flex-col -ml-2 sml:ml-4">
        ...
        <div className="mr-24 pr-14 sml:ml-4">
      ...
      />
      <div className="flex pb-10 sml:flex-col">
        <div className="flex gap-6 ml-20 mt-4 sml:ml-4 sml:flex  ">
          ...
          <div className="flex row sml:flex gap-4 sml:mt-8 ">
          <BiLogoFacebookCircle size={25} className="ml-48 sml:ml-4 " />{" "}
