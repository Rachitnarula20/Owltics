...
const Framework = () => {
  return (
    <div className='flex justify-around pt-20 pb-1'>
      ...
      <div className='flex flex-col w-[35rem] mr-52 justify-center ml-10 sml:mr-0 sml:ml-0 sml:w-60'>
        ...
        border-solid border-gray-500 mt-10 transition-all ease-in duration-300 hover:scale-105 sml:font-normal sml:px-14">
            View all Frameworks
        </button>
      </div>
    </div>
